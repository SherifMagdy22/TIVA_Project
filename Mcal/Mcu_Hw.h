...
#define GPIODATAB                              *(volatile uint32*)(GPIO_PERI_BASE_ADDRESS+0x3FC+0x1000)
#define GPIODIRB 															 *(volatile uint32*)(GPIO_PERI_BASE_ADDRESS+0x1400)
#define GPIOISB 															 *(volatile uint32*)(GPIO_PERI_BASE_ADDRESS+0x1404)
#define GPIOIBEB 															 *(volatile uint32*)(GPIO_PERI_BASE_ADDRESS+0x1408)
#define GPIOIEVB 															 *(volatile uint32*)(GPIO_PERI_BASE_ADDRESS+0x140C)
#define GPIOIMB																 *(volatile uint32*)(GPIO_PERI_BASE_ADDRESS+0x1410)
